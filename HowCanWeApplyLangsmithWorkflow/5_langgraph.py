...
#want to show new project name  "
os.environ["LANGCHAIN_PROJECT"] =  "LangGraph_ParallelWorkflow" 
...
#wrapping the llm model with structured output.
...
class UPSCState(TypedDict, total=False):
    ...
    individual_scores: Annotated[List[int], operator.add]  # Reducer merges parallel lists
    avg_score: float
