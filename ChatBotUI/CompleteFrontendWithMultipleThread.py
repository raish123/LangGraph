...
from backend import workflow, HumanMessage, AIMessage, ChatStateSchema  # chatbot backend functionalities import kar rahe hain
...
if user_input:
    try:
        ...
        def typing_effect(user_input, thread_id):
            ...
            initial_state = ChatStateSchema(message=[HumanMessage(content=user_input)])
