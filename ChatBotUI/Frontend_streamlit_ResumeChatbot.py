...
if user_input:
    # user ka message message history mein add karo
    ...
    # AI ke liye initial state prepare karo
    ...
    # AI ka response stream karte hue UI mein dikhana
    ...
    # agar AI ka response hai to use message history mein add karo
