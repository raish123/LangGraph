...
@traceable(name="load_pdf",tags=['PDFDoc','loader'],metadata={'loader':'pdfloader','doc_response':'lst_docs'})
def load_pdf(path: str):
    loader = PyPDFLoader(path)
    return loader.load()  # list[Document]


@traceable(name="split_documents",tags=['Splitter'],metadata={'chunks':'RecursiveCharacterTextSplitter','chunk_response':'lst_chunk'})
...
@traceable(name="build_vectorstore",tags=['vectorstor'],metadata={'split_chunks':'text-embedding'})
